...
- 0d1c56e: Bump @commitlint/config-conventional to ^21.2.0

## 1.0.3

### Patch Changes

- 8072249: Bump @commitlint/config-conventional to ^21.1.0
...
- b79da02: Bump `@commitlint/config-conventional` to ^21.0.1.
